...
<!-- Author -->
    <div class="flex gap-4 items-center mb-10 text-white p-10 bg-cover" 
      style="background-image: url('{{asset('assets/img/profile-bg.png')}}');">
      ...
      <div class="grid sm:grid-cols-1 gap-5 lg:grid-cols-4">
        @foreach ( $author->news as $news )
          ...
          <div
            ...
            style="height: 100%;">
            <div class="bg-primary text-white rounded-full w-fit px-5 py-1 font-normal ml-2 mt-2 text-sm absolute">{{ $news->category->title }}</div>
